...
- Compiler: `pdfLaTeX`
- Suggested comments: `56 pages, 7 figures; Supporting Information supplied as an ancillary PDF; code and reproducibility materials available from the linked repositories.`
...
The upload archive is `SMITH_arxiv_v1.zip`. Its `anc` directory contains the
three-page Supporting Information PDF. After arXiv compiles the source, compare
