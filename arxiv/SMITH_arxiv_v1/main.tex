...
\SMITH\ consumes these objects and does not recompute
...
X--H policies and an optional reduced working
...
\end{equation}
and symmetrized only after the contraction. The same frozen-coordinate API is
