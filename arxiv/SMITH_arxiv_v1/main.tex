...
of Proxima and will be described separately.\cite{Lazzari2020Proxima,Gambi2019Synthons,Lazzari2024SynthonPCS,Lazzari2025PCS141} \\
...
development of Proxima that will be described in a separate publication.
...
substitute for the full ORACLE application.  Production calculations can
...
explicitly labelled reduced ORACLE profile.  The complete implementation,
including ORACLE perception and optional Gaussian \texttt{ReadAllGIC} export,
is available in the MATRIX repository at
\url{https://github.com/yogibubu/MATRIX}.  Repository revision identifiers and
the generated \texttt{\#SMITH\_PROVENANCE} section provide the software and
perception-profile provenance for the reported results.
