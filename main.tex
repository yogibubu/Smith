...
claims precise: equivalent molecular states generate isomorphic contracts, the
contract is deterministic on a frozen state, protected semantic coordinates are
retained whenever rank compatibility allows them, block-local reduction is
insensitive to homogeneous scaling, and the discrete contract is locally stable
inside a fixed molecular-state stratum.
