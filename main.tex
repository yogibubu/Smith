...
\SONIC\ defines the non-redundant generalized internal-coordinate basis, analytic
...
from Cartesian coordinates with the bundled MATRIX perception tools.  The
...
\SONIC & Coordinate-generation engine: \GIC\ construction, symmetry-adapted
...
\end{tikzpicture}
\caption{Constructive workflow implemented by \NEO.  The model-building stage
...
contracts.  Symmetry is used in the classical molecular sense: point-group
...
contract is already usable as an external solver coordinate set; the next
iteration-count comparison will place \SONIC\ against Gaussian defaults,
Cartesians and hand-built Z matrices on the same systems.  The Hessian,
...
generated with the \SONIC\ development tree and Python 3.13.11.  Gaussian
...
used to generate the tables and application plots.  The \SONIC\ source
code is under active development as an independently usable MATRIX package;
