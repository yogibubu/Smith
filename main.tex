...
\title{Automatic Construction and Validation of Non-Redundant Symmetry-Oriented Natural Internal Coordinates}
...
The corresponding native-coordinate norbornane check, also run with the same
total-symmetric active subset, contains 51 generated rows of which 36
non-totally symmetric rows are marked \texttt{Frozen}; it converges in five
steps.  This is a distinct input from the Gaussian 16 \texttt{ReadAllGIC}
compatibility run above and isolates the out-of-plane and frozen-irrep handling
before export through the commercial Gaussian parser.
