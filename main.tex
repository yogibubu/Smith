...
subsets for geometry optimization, Wilson GF analysis, vibrational scaling,
force-field construction, DVR puckering grids, PES fitting and
semi-experimental least-squares refinement.  A separate functional layer can
then evaluate inverse or
...
single numerical tolerance, but the comparison is performed on normalized Wilson
rows,
\begin{equation}
...
order in which the rank test is allowed to compare rows.  Special protected
