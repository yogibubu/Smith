...
variables in GF/PED, future TRINITY and SMITH workflows, or MORPHEUS.
...
rigid bonds contribute less to the puckering row.  A natural next step is to
promote this weighting into a formal rigid-subspace reduction when ORACLE
perception identifies double bonds, conjugated fragments or other locally stiff
ring units.  This would keep the active GIC basis linear while exposing
Cremer--Pople amplitudes and phases as derived functions for sampling, PES
fitting and conformer classification.
