...
manuscript snapshot is tagged \texttt{v0.1.0rc6}.  Its dependency lock and
checksums are recorded with the archived submission.  Gaussian
...
\texttt{v0.1.0rc6}. Repository revisions, the dependency lock and
