...
The commercial Gaussian 16 compatibility input uses the Fortran/G16 improper
dihedral convention \(U(I,J,K,L)\mapsto D(J,I,L,K)\), giving
\(D(4,6,8,7)\) for the same local non-planarity.
