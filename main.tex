...
fragments.  We introduce a deterministic protocol that accepts a frozen molecular
...
protects ring and fragment semantics; and applies analytic Wilson-matrix row
rank tests followed by local and molecular symmetry projection.
...
and reproducible external serialization; Gaussian 16 provides an independent
parser and solver for one external representation of the generated coordinates.
The resulting frozen contract retains chemically readable decompositions,
...
\url{https://github.com/yogibubu/Smith/tree/9f34f832d6f0a9ca200efec9b93d50cec62871f4}
contains the scripts, JSON data files, figures and Supporting Information used
to generate the tables and application plots, including
\texttt{data/construction\_scaling\_benchmark.json},
\texttt{data/local\_salc\_validation.json},
\texttt{data/cyclohexane\_puckering\_equivalence.json},
\texttt{data/gaussian\_coordinate\_comparison.json},
\texttt{data/native\_out\_of\_plane\_probe.json},
\texttt{data/readallgic\_optimization\_results.json} and
\texttt{data/application\_results.json}, together with their generating
scripts.  The same repository contains a reduced standalone Python package,
installation instructions and the water, norbornane, formic-acid--water,
...
standalone distribution at tag
\url{https://github.com/yogibubu/Smith/tree/v0.1.0rc7/standalone} includes the revision-pinned topology, point-group
...
\texttt{v0.1.0rc7}; the repository revision containing the cited manuscript
artifacts is pinned above. Repository revisions, the dependency lock and
