...
The Gaussian file in the second listing is then produced from that contract
with the commercial Gaussian 16 compatibility switch, for example
\texttt{smith gicforge gaussian-input norbornane.xyzin norbornane.gjf --g16}.
