...
def build_parser(
    *,
    ...
    gf.add_argument(
        "--cv-correction-amplitude-model",
        choices=("radius-aware-period-line", "bond-scale-period-line"),
        default="radius-aware-period-line",
        help="Final CV_radial posterior amplitude model used with the Gaussian locality weight",
    )
    gf.add_argument(
    ...
    trinity_scan_run.add_argument(
        "--backend",
        choices=(
            "gaussian", "g16", "gdv", "orca", "molpro", "mrcc", "cfour", "xtb", "pyscf", "architect"
        ),
        ...
        if args.xyzin is None:
            ...
            if args.write_hessian_section:
                ...
                report = run_xyzin_gf_report_from_hessian_input(
                    ...
                    cv_correction_amplitude_model=args.cv_correction_amplitude_model,
