...
TOOL_CONTRACTS: tuple[ToolContract, ...] = (
    ...
    ToolContract(
        ...
        consumed_artifacts=("oracle.xyz.primitives.v1",),
        produced_artifacts=(
    ...
    ToolContract(
        ...
        notes=(
            ...
            "Owns ZION fitting, quantitative coupling audits and the stable analytic E/G/H "
    ...
    ToolContract(
        key="link",
        display_name="LINK",
        current_package="matrix-trinity (temporary implementation package)",
        standalone_command=(
        ...
        notes=(
            ...
            "with finite-difference derivative recovery. Current code lives in matrix-trinity "
            "until the package is renamed or split."
        ),
    ),
    ToolContract(
        key="rovib",
