...
class GaussianPointResult:
    """Single-point energy and Cartesian gradient parsed from a Gaussian log."""
...
def read_gaussian_point_result(path: Path) -> GaussianPointResult:
    """Read the final energy and Cartesian gradient from a Gaussian force log.
    ...
    return GaussianPointResult(
        ...
        gradient_hartree_per_bohr=-forces.reshape(-1),
        normal_termination=NORMAL_TERMINATION in text,
