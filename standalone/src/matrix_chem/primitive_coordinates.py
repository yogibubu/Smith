...
ORACLE_XYZ_PRIMITIVES_SCHEMA = "oracle.xyz.primitives.v1"
...
def primitive_contract_section_lines(contract: PrimitiveCoordinateContract) -> list[str]:
    lines = [
        ...
        f"ALIAS_SCHEMA {ORACLE_XYZ_PRIMITIVES_SCHEMA}",
        "OWNER ORACLE",
...
def read_primitive_contract(path: Path) -> PrimitiveCoordinateContract:
    ...
    if schema not in {MATRIX_XYZ_PRIMITIVES_SCHEMA, ORACLE_XYZ_PRIMITIVES_SCHEMA}:
