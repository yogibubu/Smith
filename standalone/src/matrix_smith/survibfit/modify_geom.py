...
def _load_topology_bond_order():
    from matrix_chem.topology.continuous_graph import bond_order
...
def _bdpcs3_pyykko_single_double_triple(z: int):
    from matrix_chem.topology.pykko_radii import bond_multiplicity_reference_radii

    return bond_multiplicity_reference_radii(
        int(z),
